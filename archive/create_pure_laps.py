...
def generate_pure_fastest_laps():
    print("מתחיל בעיבוד הנתונים ליצירת קובץ הזהב...")
    ...
    for track in tracks:
        ...
        # המרת זמנים
# המרת זמנים מותאמת למניעת קריסות
        ...
        # (הקפה היא pit-in אם ההקפה הבאה של הנהג היא pit-out, או שאין לה lap_duration)
        ...
        for _, lap in fastest_laps.iterrows():
            ...
            # סינון הדאטה לחלון הזמן הרלוונטי וסידור לפי זמן (קריטי ל-merge_asof)
            ...
            # שמירת העמודות הרלוונטיות לפרויקט
